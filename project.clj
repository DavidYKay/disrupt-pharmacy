(defproject disrupt-pharmacy "0.1.0-SNAPSHOT"
  ...
  :uberjar-name "disrupt-pharmacy.jar"

  ;; Use `lein run` if you just want to start a HTTP server, without figwheel
  :main disrupt-pharmacy.server
  ...
  :cljsbuild {:builds
              {:app
               {:source-paths ["src/cljs"]
                ...
                ;; :figwheel {:on-jsload "disrupt-pharmacy.core/on-figwheel-reload"}

                :compiler {:main disrupt-pharmacy.core
                           :asset-path "js/compiled/out"
                           :output-to "resources/public/js/compiled/disrupt_pharmacy.js"
                          ...
                          {:test
                           {:source-paths ["src/cljs" "test/cljs"]
                            ...
                            {:output-to "resources/public/js/compiled/testable.js"
                             :main disrupt-pharmacy.test-runner
                             :optimizations :none}}}}}
